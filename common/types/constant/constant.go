...
const (
	REQUEST_BUSINESS_TYPE_INSERT = 1 // Add
	REQUEST_BUSINESS_TYPE_UPDATE = 2 // Modify
	REQUEST_BUSINESS_TYPE_DELETE = 3 // Delete
	REQUEST_BUSINESS_TYPE_GRANT  = 4 // Grant
	REQUEST_BUSINESS_TYPE_EXPORT = 5 // Export
	REQUEST_BUSINESS_TYPE_IMPORT = 6 // Import
	REQUEST_BUSINESS_TYPE_FORCE  = 7 // Force logout
	REQUEST_BUSINESS_TYPE_GENCOD = 8 // Generate code
	REQUEST_BUSINESS_TYPE_CLEAN  = 9 // Clear data
)
